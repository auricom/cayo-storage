...
curl -sSfL --output "${exiftool_installer}/exiftool.tar.gz" "https://exiftool.org/Image-ExifTool-${exiftool_version}.tar.gz"
tar xvf "${exiftool_installer}/exiftool.tar.gz" --strip-components=1 -C "${exiftool_installer}"
mv "${exiftool_installer}/exiftool" /usr/sbin/exiftool
chown root:root /usr/sbin/exiftool
